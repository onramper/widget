    ...
    return (
        <>
            ...
            <div
                ...
                className={`${styles["chat"]} ${!intro ? (isDone === 0 ? '' : styles[isClicked ? 'shy--unhover' : 'shy']) : styles['hi']} ${isChatOpen ? styles["active"] : ''}`}
                onClick={(e) => {
                    e.preventDefault()
                ...
                }}>
                {
                    ...
                    <div className={`${styles['anim-container']}`}>
                        <div className={styles["background"]}><span onClick={(e) => e.preventDefault()} className={styles["background-text"]}>{!isChatOpen ? "Do you need help?" : "\xA0\xA0\xA0\xA0Hide live chat"}</span></div>

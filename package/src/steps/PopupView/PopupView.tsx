    ...
    <main className={`${stylesCommon.body} ${styles.body}`}>
      {
        <>
          <InfoBox
            in={!!props.processFinished && !!props.uploadFailed}
          ...
          <InfoBox
            ...
            className={`${stylesCommon.body__child} ${styles.body__child}`}
          >
            Please make sure there is enough light for your documents and face
            to be clearly visible. Printed photocopies are not accepted.
          </InfoBox>
        </>
      }
        ...
        {(props.fatalError && (
          ...
          (type === StepType.popup && (
            <div className={`${styles.center}`}>
              ...
              >
                Coinify is legally required to have proof of your identity.
                After clicking the button bellow, please follow the instructions
                to upload and verify your documents.{" "}
              </span>
                ...
                <ButtonAction
                  ...
                  onClick={
                    !props.processFinished && !props.uploadFailed
                      ...
                      : () => {
                          console.log(
                            "tried to do fail step",
                            props.processFinished,
                            props.uploadFailed
                          );
                          replaceScreen(
                            <Step
                              gtmToBeRegisterStep={props.nextStep}

...
function BodyBuyCrypto(props: { onBuyCrypto: () => void, onPickCrypto: () => void }) {
    return (
        <main className={stylesCommon.body}>
            <InputButton onClick={props.onPickCrypto} className={stylesCommon['body__child']} label="I want to buy" selectedOption="Bitcoin" icon={IconBTC} />
            ...
            <button onClick={props.onBuyCrypto} className={`${stylesCommon['body__child']} ${styles['button-action']}`}>Get crypto</button>
        </main>
    )
}

...
test('verifyEmail stores the right token', async () => {
  ...
  expect((await getTxJwtToken('123')).jwtToken).toMatchInlineSnapshot(
    `"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..8PkpQdeddAw24yWO5pVaLoWMeh4oAcwmTXhNf5WkaUw"`
  );
});
